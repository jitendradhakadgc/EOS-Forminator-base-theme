...
/* Template Name: Risk Consultancy Service Landing Repeated Category */

get_header(); ?>
<?php while ( have_posts() ) : the_post(); ?>

<?php get_template_part( 'template-parts/component/component', 'titlesubsectorrisk' ); ?>
...
<div class="toggle_container">
    ...
    <?php
    global $post_id;
            $category_slug = 'intel-adise-risk-consulatamcy';
						$args = array(
							'post_type' => 'post',
							'post_status' => 'publish',
