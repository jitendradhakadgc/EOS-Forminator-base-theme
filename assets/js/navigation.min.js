...
return}else{var evt=e||window.event;if(!(evt.which===3||evt.button===2)){if(isDropdownTapped){this._toggleDropdown(targetEl)}else{this.toggle()}}}}},_onKeyUp:function(e){var evt=e||window.event,targetEl=e.target,isDropdownTapped=!1;if(hasClass(targetEl,"dropdown-toggle")&&opts.enableDropdown)isDropdownTapped=!0;if(evt.keyCode===13){if(isDropdownTapped){this._toggleDropdown(targetEl)}else{this.toggle()}}},_calcHeight:function(){var savedHeight=0;for(var i=0;i<nav.inner.length;i++){savedHeight+=nav.inner[i].offsetHeight}
